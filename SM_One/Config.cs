...
namespace SM_One
{
    ...
    {
        public static int VoucherSeries, InvoiceSeries,GroupCode,Semester1Start,Semester1End,Semester2Start,Semester2End;
        public static string DebitAccount, CreditAccount, AccountFrom, ProgramDim, ProratedOn, SendInvoice, PricedOn,Server,Database,Username,Password, GlobalConnection;
        ...
        public static void LoadConfig()
        {
            ...
            try
            {
                ...
                ProgramDim = oRec.Fields.Item("U_ProgramDim").Value.ToString();
                ...
                oRec.DoQuery("Select T0.\"U_Freight\",T0.\"U_Enabled\",T0.\"LineId\",T1.\"ExpnsName\" from \"@ONF2\" T0 inner join OEXD T1 on T0.\"U_Freight\" = T1.\"ExpnsCode\"  where T0.\"Code\" = 'CONF' and T0.\"U_Freight\" != ''");
                FreightCodes.Clear();
                while (!oRec.EoF)
                {
                    StatusConfig statusConfig = new StatusConfig();
    ...
    {
        public string Status, Program, Courses, FreightCode, FreightEnabled, Line, FreightName;
    }
}
