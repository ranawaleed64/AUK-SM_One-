...
namespace SM_One
{
    [FormAttribute("SM_One.SMConfig", "SMConfig.b1f")]
    class SMConfig : UserFormBase
    {
        ...
        public override void OnInitializeComponent()
        {
            ...
            this.cbAllowWOTrail = ((SAPbouiCOM.CheckBox)(this.GetItem("cbAWOTrail").Specific));
            this.Folder0.Select();
        ...
        private SAPbouiCOM.CheckBox cbAllowWOTrail;
